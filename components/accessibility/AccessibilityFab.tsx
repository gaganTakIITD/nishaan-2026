...
export function AccessibilityFab() {
  ...
  return (
    ...
    >
      ...
      <AccessibilityIcon className="h-5 w-5 transition-transform group-hover:scale-110" />
    </button>
  );
}
